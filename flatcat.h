...
struct DeviceSettings {
  String hostname; String ip; String gateway; String subnet; String title1;
  String title2; long gmtOffset; int daylightOffset;
};
...
String createAlpacaJSON(long clientID, int errorNum, String errorMsg, const char* valueType, String value);
...
void handleAlpacaCoverCalibrator(long clientID, long transactionID, int deviceNum);

// --- Custom Web Server/Hardware Functions (web_handlers.cpp) ---
void handleRoot(); void handleSettings(); void handleGetTime(); void handleSlider1(); void handleSlider2(); 
void handleOpen1(); void handleClose1(); void handleOpen2(); void handleClose2(); void handleGetAllStatus(); 
void handleGetSettings(); void handleSave(); void handleScan(); void handleSaveWifi(); void handleNotFound(); 
